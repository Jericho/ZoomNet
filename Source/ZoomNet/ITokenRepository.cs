...
namespace ZoomNet
{
	...
	public interface ITokenRepository
	{
		...
		Task<(string RefreshToken, string AccessToken, DateTime TokenExpiration)> GetTokenInfoAsync(CancellationToken cancellationToken);
		...
		/// <param name="cancellationToken">The cancellation token.</param>
		/// <returns>The async task.</returns>
		Task SaveTokenInfoAsync(string refreshToken, string accessToken, DateTime tokenExpiration, CancellationToken cancellationToken = default);
