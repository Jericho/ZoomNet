...
namespace ZoomNet.Resources
{
	...
	public interface IWebinars
	{
		...
		/// </returns>
		Task<PaginatedResponse<Webinar>> GetAllAsync(string userId, int recordsPerPage = 30, int page = 1, CancellationToken cancellationToken = default(CancellationToken));
	}
}
