...
namespace ZoomNet.Resources
{
	...
	public interface IMeetings
	{
		...
		/// </returns>
		Task<BatchRegistrantInfo> PerformBatchRegistration(long meetingId, BatchRegistrant[] registrants, bool autoApprove = false, bool registrantsConfirmationEmail = false, CancellationToken cancellationToken = default);
