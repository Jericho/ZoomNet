...
namespace ZoomNet.Resources
{
	...
	public interface IPastWebinars
	{
		...
		/// </returns>
		Task<PaginatedResponseWithToken<Participant>> GetAbsenteesAsync(string uuid, int recordsPerPage = 30, string pageToken = null, CancellationToken cancellationToken = default);
