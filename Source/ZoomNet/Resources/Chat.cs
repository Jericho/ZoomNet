...
namespace ZoomNet.Resources
{
	...
	public class Chat : IChat
	{
		...
		/// <inheritdoc/>
		public Task<ChatMembersEditResult> PromoteMembersToAdminsInAccountChannelAsync(string userId, string channelId, IEnumerable<string> emails, CancellationToken cancellationToken = default)
		{
			if (emails == null || !emails.Any()) throw new ArgumentNullException(nameof(emails), "You must specify at least one member to invite");
		...
		/// <inheritdoc/>
		public Task DemoteAdminsInAccountChannelAsync(string userId, string channelId, IEnumerable<string> adminIds = null, CancellationToken cancellationToken = default)
		{
		...
		/// <inheritdoc/>
		public Task DemoteUsersInAccountChannelAsync(string userId, string channelId, IEnumerable<string> userIds = null, CancellationToken cancellationToken = default)
		{
