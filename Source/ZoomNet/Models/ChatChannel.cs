...
namespace ZoomNet.Models
{
	...
	public class ChatChannel
	{
		...
		/// <summary>Gets or sets the {Zoom does not provide documentation for this field}.</summary>
		...
		/// <summary>Gets or sets the settings for the channel.</summary>
