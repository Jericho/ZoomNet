...
{
	/// <summary>An event access link.</summary>
	public class EventAccessLink
	{
		...
		/// <remarks>This field applies only to group-join link type. This establishes the access permissions of the user within the event.</remarks>
