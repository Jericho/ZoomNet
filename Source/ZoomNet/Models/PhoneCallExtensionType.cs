...
{
	/// <summary>Phone number extension type.</summary>
	public enum PhoneCallExtensionType
	{
		...
		/// <summary>PSTN (public switched telephone network).</summary>
		[EnumMember(Value = "pstn")]
		Pstn,

		/// <summary>Five9 (cloud contact center provider).</summary>
		[EnumMember(Value = "five9")]
		Five9,

		/// <summary>Twilio (cloud communications company).</summary>
