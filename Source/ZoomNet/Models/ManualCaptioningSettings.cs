...
namespace ZoomNet.Models
{
	...
	public class ManualCaptioningSettings
	{
		...
		[JsonProperty(PropertyName = "allow_to_type")]
		...
		[JsonProperty(PropertyName = "auto_generated_captions")]
		...
		[JsonProperty(PropertyName = "full_transcript")]
		...
		[JsonProperty(PropertyName = "manual_captions")]
		...
		[JsonProperty(PropertyName = "save_captions")]
