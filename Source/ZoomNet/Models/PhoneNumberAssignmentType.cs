...
{
	/// <summary>Specifies the assignment status for a phone number in the Zoom Phone API.</summary>
	/// <remarks>
	/// <list type="table">
	...
	{
		/// <summary>Number has been assigned to a user, call queue, auto-receptionist, or common area.</summary>
		[EnumMember(Value = "assigned")]
		Assigned,

		/// <summary>Number is not assigned to anyone.</summary>
		[EnumMember(Value = "unassigned")]
		Unassigned,

		/// <summary>Include both assigned and unassigned numbers in the response.</summary>
		[EnumMember(Value = "all")]
		All,

		/// <summary>Include Bring Your Own Carrier (BYOC) numbers only in the response.</summary>
