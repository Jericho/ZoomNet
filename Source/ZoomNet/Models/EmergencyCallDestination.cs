...
{
	/// <summary>Emergency call routing destination.</summary>
	public enum EmergencyCallDestination
	{
		/// <summary>PSAP (Public safety answering point).</summary>
		[EnumMember(Value = "PSAP")]
		Psap,

		/// <summary>Internal safety response team.</summary>
		...
		/// <summary>Both PSAP and safety team.</summary>
		[EnumMember(Value = "BOTH")]
		BothPsapAndSafetyTeam,

		/// <summary>Mobile 911 call.</summary>
		...
		/// <summary>Both safety team and SIP group.</summary>
		[EnumMember(Value = "BOTH_SAFETY_TEAM_AND_SIP")]
		BothSafetyTeamAndSip,

		/// <summary>SIP group due to overflow.</summary>
		[EnumMember(Value = "OVERFLOW_TO_SIP_GROUP")]
		OverflowToSipGroup,

		/// <summary>PSAP due to missed by safety team.</summary>
