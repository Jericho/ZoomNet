...
{
	/// <summary>Enumeration to indicate the type of network a participant used to join a meeting.</summary>
	public enum ParticipantNetwork
	{
		/// <summary>An unknown network.</summary>
		...
		/// <summary>3G, 4G and 5G cellular.</summary>
