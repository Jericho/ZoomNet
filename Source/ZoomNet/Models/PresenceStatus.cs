...
{
	/// <summary>Enumeration to indicate the presence status of a user.</summary>
	public enum PresenceStatus
	{
		...
		/// <summary>In calendar event.</summary>
		...
		/// <summary>In a Zoom meeting.</summary>
		[EnumMember(Value = "In_A_Meeting")]
		InMeeting,

		/// <summary>On a call.</summary>
