...
{
	/// <summary>Room basic profile.</summary>
	public class RoomBasicProfile
	{
		/// <summary>Gets or sets the code used to complete the setup of the Zoom Room.</summary>
		[JsonPropertyName("activation_code")]
		public string ActivationCode { get; set; }

		/// <summary>Gets or sets the calendar ressource ID.</summary>
		[JsonPropertyName("calendar_resource_id")]
		public string CalendarResourceId { get; set; }

		/// <summary>Gets or sets the in-room participant capacity of the Zoom Room.</summary>
		[JsonPropertyName("capacity")]
		public int Capacity { get; set; }

		/// <summary>Gets or sets the short display name of the Zoom Room.</summary>
		[JsonPropertyName("display_name")]
		public string DisplayName { get; set; }

		/// <summary>Gets or sets a value indicating whether to hide this Zoom Room from your contact list. True to hide. False to show.</summary>
		[JsonPropertyName("hide_room_in_contacts")]
		public bool HideRoomInContacts { get; set; }

		/// <summary>Gets or sets the location ID of the place where the Zoom Room was added.</summary>
		[JsonPropertyName("location_id")]
		public string LocationId { get; set; }

		/// <summary>Gets or sets the name of the Zoom Room.</summary>
		[JsonPropertyName("name")]
		public string Name { get; set; }

		/// <summary>Gets or sets a value indicating whether to require a code to exit out of the Zoom Rooms application to switch between other apps.</summary>
		...
		/// <summary>Gets or sets the email address to use for reporting Zoom Room issues.</summary>
		[JsonPropertyName("support_email")]
		public string SupportEmail { get; set; }

		/// <summary>Gets or sets the phone number to use for reporting Zoom Room issues.</summary>
		[JsonPropertyName("support_phone")]
		public string SupportPhone { get; set; }

		/// <summary>Gets or sets the list of tag ID associated with the Zoom Room.</summary>
		...
		/// <summary>Gets or sets the user ID of the user assigned to a Personal Zoom Room. Note: this field will only be present for Personal Zoom Rooms.</summary>
