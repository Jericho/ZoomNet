...
namespace ZoomNet.Models
{
	...
	{
		/// <summary>Gets or sets the participant's audio quality.</summary>
		/// <remarks>
		...
		/// <summary>Gets or sets the participant connection type.</summary>
		[JsonPropertyName("connection_type")]
		public string ConnectionType { get; set; }

		/// <summary>Gets or sets a participant identifier.</summary>
		/// <remarks>This value can be numbers or characters, up to a maximum length of 15 characters.</remarks>
		[JsonPropertyName("customer_key")]
		public string CustomerKey { get; set; }

		/// <summary>Gets or sets the data center where participant's meeting data is stored.</summary>
		[JsonPropertyName("data_center")]
		public string DataCenter { get; set; }

		/// <summary>Gets or sets the device(s) used by the participant to join the meeting.</summary>
		...
		/// <summary>Gets or sets the meeting participant's SIP From header URI.</summary>
		/// <remarks>The API only returns this response when the participant joins a meeting via SIP.</remarks>
		...
		/// <summary>Gets or sets the participant's IP address.</summary>
		...
		/// <summary>Gets or sets the Possible reasons for why participant left the meeting.</summary>
		...
		/// <summary>Gets or sets the participant's location.</summary>
		...
		/// <summary>Gets or sets the type of microphone that participant used during the meeting.</summary>
		[JsonPropertyName("microphone")]
		public string Microphone { get; set; }

		/// <summary>Gets or sets the participant's network type.</summary>
		[JsonPropertyName("network_type")]
		public ParticipantNetwork NetworkType { get; set; }

		/// <summary>Gets or sets the device operation system.</summary>
		[JsonPropertyName("os")]
		public string OperatingSystem { get; set; }

		/// <summary>Gets or sets the device operation system version.</summary>
		...
		/// <summary>Gets or sets a value indicating whether or not recording was used during the meeting.</summary>
		[JsonPropertyName("recording")]
		public bool Recording { get; set; }

		/// <summary>Gets or sets the participant's unique registrant ID.</summary>
		...
		/// <summary>Gets or sets the participant's role.</summary>
		[JsonPropertyName("role")]
		public string Role { get; set; }

		/// <summary>Gets or sets the participant's screen share quality.</summary>
		/// <remarks>
		/// The API only returns this value when the Meeting quality scores and network alerts
		/// on Dashboard setting is enabled in the Zoom Web Portal and the Show meeting quality
		/// score and network alerts on Dashboard option is selected in Account Settings.
		...
		/// <summary>Gets or sets a value indicating whether or not a user selected to share an iPhone/iPad application during the screen-share.</summary>
		[JsonPropertyName("share_application")]
		public bool ShareApplication { get; set; }

		/// <summary>Gets or sets a value indicating whether or not a user selected to share their desktop during the screen-share.</summary>
		[JsonPropertyName("share_desktop")]
		public bool ShareDesktop { get; set; }

		/// <summary>Gets or sets a value indicating whether or not a user selected to share their white-board during the screen-share.</summary>
		[JsonPropertyName("share_whiteboard")]
		public bool ShareWhiteboard { get; set; }

		/// <summary>Gets or sets the meeting participant's SIP (Session Initiation Protocol) Contact header URI.</summary>
		/// <remarks>The API only returns this response when the participant joins a meeting via SIP.</remarks>
		[JsonPropertyName("sip_uri")]
		public string SipUri { get; set; }

		/// <summary>Gets or sets the type of speaker participant used during the meeting.</summary>
		...
		/// <summary>Gets or sets the participant's video quality.</summary>
		/// <remarks>
		/// The API only returns this value when the Meeting quality scores and network alerts
		/// on Dashboard setting is enabled in the Zoom Web Portal and the Show meeting quality
		/// score and network alerts on Dashboard option is selected in Account Settings.
