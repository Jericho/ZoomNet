...
namespace ZoomNet.Models.Webhooks
{
	...
	{
		/// <summary>Gets or sets the account id of the user who created the meeting.</summary>
		...
		/// <summary>Gets or sets information about the meeting's devices test results.</summary>
