...
{
	/// <summary>Basic information about a ticket assigned to an event registrant.</summary>
	public class EventTicketSummary
	{
		/// <summary>Gets or sets the event authentication method for the ticket.</summary>
