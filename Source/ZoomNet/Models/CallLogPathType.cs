...
namespace ZoomNet.Models
{
	...
	public enum CallLogPathType
	{
		...
		/// <summary>ivrMenu.</summary>
		[EnumMember(Value = "ivrMenu")]
		IvrMenu,

		/// <summary>companyDirectory.</summary>
		...
		/// <summary>tollFreeBilling.</summary>
		...
		/// <summary>parkPickup.</summary>
		[EnumMember(Value = "parkPickup")]
		ParkPickup,

		/// <summary>parkTimeout.</summary>
