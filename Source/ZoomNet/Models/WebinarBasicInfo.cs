...
{
	/// <summary>Provides basic information about webinar.</summary>
	public class WebinarBasicInfo
	{
		...
		*/
		...
		/// <summary>Gets or sets the webinar's unique id. Each webinar instance generates a webinar uuid.</summary>
