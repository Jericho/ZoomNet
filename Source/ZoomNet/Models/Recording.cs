...
namespace ZoomNet.Models
{
	...
	{
		/// <summary>Gets or sets the ID of the user account who completed the recording.</summary>
		[JsonPropertyName("account_id")]
		public string AccountId { get; set; }

		/// <summary>Gets or sets a value indicating whether cloud recording deletion is enabled.</summary>
		/// <remarks>
		...
		/// <summary>Gets or sets the date on which the recording will be auto-deleted.</summary>
		/// <remarks>This value is returned only if <see cref="AutoDelete"/> is TRUE.</remarks>
		...
		/// <summary>Gets or sets the host's email.</summary>
		[JsonPropertyName("host_email")]
		public string HostEmail { get; set; }

		/// <summary>Gets or sets a value indicating whether the recording is an on-premise recording.</summary>
		...
		/// <summary>Gets or sets the cloud recording's passcode to be used in the URL.</summary>
		/// <remarks>Directly splice recording's passcode in play_url or share_url with ?pwd= to access and play.</remarks>
		...
		/// <summary>Gets or sets the total size of the recording files and audio files in bytes.</summary>
		[JsonPropertyName("total_size")]
		public long TotalSize { get; set; }

		/// <summary>Calculates the total duration covered by all recording files.</summary>
		...
		/// <summary>Retrieves the primary video recording file from the collection.</summary>
		...
		/// <summary>Gets the first audio-only recording file from the collection, if available.</summary>
		...
		/// <summary>Gets the first chat log recording file, if available.</summary>
		...
		/// <summary>Gets the first recording file of type Timeline from the collection.</summary>
