...
{
	/// <summary>Information regarding an invoice item.</summary>
	public class BillingInvoiceItem
	{
		/// <summary>Gets or sets the description of the charge.</summary>
		[JsonPropertyName("charge_name")]
		public string Description { get; set; }

		/// <summary>Gets or sets the identifier of the charge.</summary>
		[JsonPropertyName("charge_number")]
		public string ItemId { get; set; }

		/// <summary>Gets or sets the type of the charge.</summary>
		...
		/// <summary>Gets or sets the billing end date.</summary>
		[JsonPropertyName("end_date")]
		public DateTime EndDate { get; set; }

		/// <summary>Gets or sets the partner SKU.</summary>
		...
		/// <summary>Gets or sets the billing start date.</summary>
