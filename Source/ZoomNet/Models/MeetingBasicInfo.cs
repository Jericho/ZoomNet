...
{
	/// <summary>Represents minimal information provided about the meeting.</summary>
	public class MeetingBasicInfo
	{
		...
		*/
		...
		/// <summary>Gets or sets the unique id. Each meeting instance generates a meeting uuid.</summary>
