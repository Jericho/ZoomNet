...
#pragma warning restore IDE0130 // Namespace does not match folder structure
{
	...
	internal static class Internal
	{
		...
		// From: https://stackoverflow.com/questions/4483886/how-can-i-get-a-count-of-the-total-number-of-digits-in-a-number/51099524#51099524
		internal static int GetNumberOfDigits(this int n)
		{
			if (n >= 0)
			{
				if (n < 10) return 1;
		...
		// From: https://stackoverflow.com/questions/4483886/how-can-i-get-a-count-of-the-total-number-of-digits-in-a-number/51099524#51099524
		internal static int GetNumberOfDigits(this long n)
		{
			if (n >= 0)
			{
				if (n < 10L) return 1;
